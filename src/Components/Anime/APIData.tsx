  ...
  return (
    <div className="flex flex-col w-[14em] py-3 px-4 mt-4 bg-zinc-700 rounded gap-3">
      ...
      <div className="flex flex-col text-xs gap-1">
        ...
        <p className="text-zinc-400">{APIResponse.season}</p>
      </div>
      <div className="flex flex-col text-xs gap-1">
        <p className="font-medium text-sm">Year</p>
        <p className="text-zinc-400">{APIResponse.year}</p>
      </div>
      <div className="flex flex-col text-xs gap-1">
      ...
      <div className="flex flex-col text-xs gap-1">
        ...
        {APIResponse.studios.map((studio: any) => (
          <p key={studio.name} className="text-zinc-400">
            {studio.name}
          </p>
        ))}
      </div>
      ...
      <div className="flex flex-col text-xs gap-2">
        {APIResponse.titles.map((studio: any) => (
          <div key={studio.title} className="flex flex-col gap-1">
